...
/// Start Work View - Form to start work
class StartWorkView extends StatefulWidget {
  const StartWorkView({super.key});
...
class _StartWorkViewState extends State<StartWorkView> {
  ...
  Future<void> _startWork() async {
    ...
    try {
      ...
      if (!mounted) return;
      CustomSnackbar.showSuccess(context, 'Work started successfully');
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: controller.isLoading.value ? null : _startWork,
